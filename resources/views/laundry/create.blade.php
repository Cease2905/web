<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h4 mb-0">Tambah Data Laundry</h2>
                        ...
                        <form action="{{ route('laundry.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('alamat_pelanggan') is-invalid @enderror" 
                                    id="alamat_pelanggan" name="alamat_pelanggan" rows="3" required>{{ old('alamat_pelanggan') }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('jenis_laundry') is-invalid @enderror" 
                                    ...
                                    <option value="Kiloan" {{ old('jenis_laundry') == 'Kiloan' ? 'selected' : '' }}>Kiloan</option>
                                    <option value="Satuan" {{ old('jenis_laundry') == 'Satuan' ? 'selected' : '' }}>Satuan</option>
                                </select>
                                @error('jenis_laundry')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('total_pembayaran') is-invalid @enderror" 
                                        id="total_pembayaran" name="total_pembayaran" value="{{ old('total_pembayaran') }}" required>
                                </div>
